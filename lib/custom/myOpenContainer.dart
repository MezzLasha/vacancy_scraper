...
typedef MyOpenContainerBuilder<S> = Widget Function(
...
/// contents will use.
enum MyOpenContainerTransitionType {
...
class MyOpenContainer<T extends Object?> extends StatefulWidget {
  ...
  const MyOpenContainer({
    ...
    this.transitionType = MyOpenContainerTransitionType.fadeThrough,
  ...
  /// with [MyOpenContainerTransitionType.fadeThrough].
  ///
  ...
  /// argument.
  ///
  /// If no value is returned via [Navigator.pop] or [MyOpenContainer.openBuilder.action],
  ...
  /// container.
  final MyOpenContainerBuilder<T> openBuilder;
  ...
  ///
  /// Defaults to [MyOpenContainerTransitionType.fade].
  final MyOpenContainerTransitionType transitionType;
  ...
  @override
  State<MyOpenContainer<T?>> createState() => _MyOpenContainerState<T>();
}
...
class _MyOpenContainerState<T> extends State<MyOpenContainer<T?>> {
  ...
  Future<void> myOpenContainer() async {
    final Color middleColor =
  ...
  Widget build(BuildContext context) {
    return _Hideable(
      ...
      child: GestureDetector(
        onTap: widget.tappable ? myOpenContainer : null,
        child: Material(
          ...
          child: Builder(
            ...
            builder: (BuildContext context) {
              return widget.closedBuilder(context, myOpenContainer);
            },
          ),
        ),
      ),
...
class _OpenContainerRoute<T> extends ModalRoute<T> {
  ...
  static _FlippableTweenSequence<Color?> _getColorTween({
    required MyOpenContainerTransitionType transitionType,
    required Color closedColor,
    required Color openColor,
    required Color middleColor,
  }) {
    switch (transitionType) {
      case MyOpenContainerTransitionType.fade:
      ...
      case MyOpenContainerTransitionType.fadeThrough:
        return _FlippableTweenSequence<Color?>(
          <TweenSequenceItem<Color?>>[
            TweenSequenceItem<Color?>(
  ...
  static _FlippableTweenSequence<double> _getClosedOpacityTween(
      MyOpenContainerTransitionType transitionType) {
    switch (transitionType) {
      case MyOpenContainerTransitionType.fade:
